  ...
  return (
    <div className="w-full flex justify-center px-4">
      <form
        ...
        className="w-full max-w-lg bg-white rounded-lg shadow-lg p-8 space-y-4 border border-gray-200"
      >
        <h2 className="text-xl font-bold text-center lalezar-font mb-4">
          فرم ثبت‌نام نخ‌نت
        </h2>
